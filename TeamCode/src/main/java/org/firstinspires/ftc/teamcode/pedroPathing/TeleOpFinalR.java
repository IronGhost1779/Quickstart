...
public class TeleOpFinalR extends LinearOpMode {
    ...
    private static final double toleranciaLicuadora = 6.0; // 8
        ...
        while (opModeIsActive()) {
            ...
            if ((nudgeLeft || nudgeRight)
                ...
                if (ms >= NUDGE_PERIOD_MS) {
                    ...
                    double dir = 0.0;
                    if (nudgeRight && !nudgeLeft) dir = +4.0;
                    else if (nudgeLeft && !nudgeRight) dir = -4.0;
                    ...
                    if (dir != 0.0) {
                        ...
                        nudgeOffsetCounts = nudgeOffsetCounts + dir * step;
